...
export default async function generateOTP(email:string): Promise<string>{
    try {
        ...
        const mailOptions = {
            ...
            to: email,
            subject: 'Your Verification Code for Inkspire',
            html: `
            <div style="font-family: Arial, sans-serif; color: #333;">
              <h2 style="color: #5e9ca0;">Hello,</h2>
              <p>Thank you for signing up with Inkspire. To complete your registration, please use the following one-time password (OTP):</p>
